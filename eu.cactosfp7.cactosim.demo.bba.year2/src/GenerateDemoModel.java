...
import eu.cactosfp7.infrastructuremodels.physicaldc.architecturetype.util.ArchitecturetypeResourceImpl;
 ...
 *
 */
public class GenerateDemoModel {
	/** Logger for this class. */
	private static final Logger logger = Logger.getLogger(GenerateDemoModel.class.getCanonicalName());
