 ...
 *
 */
public class GenerateGreyBoxDemoModel {
	/** Logger for this class. */
	private static final Logger logger = Logger.getLogger(GenerateGreyBoxDemoModel.class.getCanonicalName());
	...
	public static void main(String[] args) {
		...
		// Create the model
		GreyBoxDemoModel demoModel = new GreyBoxDemoModel();
		// Architecture Type
