...
public class UsagesequenceAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
    protected UsagesequenceSwitch<Adapter> modelSwitch =
        new UsagesequenceSwitch<Adapter>() {
			@Override
			public Adapter caseUsageSequenceRepository(UsageSequenceRepository object) {
				return createUsageSequenceRepositoryAdapter();
			}
			@Override
    ...
    /**
	 * Creates a new adapter for an object of class '{@link eu.cactosfp7.cactosim.usagesequence.UsageSequenceRepository <em>Usage Sequence Repository</em>}'.
	 * <!-- begin-user-doc -->
