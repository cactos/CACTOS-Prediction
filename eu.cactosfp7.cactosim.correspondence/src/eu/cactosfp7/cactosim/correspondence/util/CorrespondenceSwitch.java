...
public class CorrespondenceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CorrespondencePackage.LOAD_CORRESPONDENCE: {
				LoadCorrespondence loadCorrespondence = (LoadCorrespondence)theEObject;
				T result = caseLoadCorrespondence(loadCorrespondence);
				if (result == null) result = caseIdentifier(loadCorrespondence);
