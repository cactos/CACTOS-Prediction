...
/**
 * This is the item provider adapter for a {@link eu.cactosfp7.cactosim.experimentscenario.request.TerminateApplicationRequest} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TerminateApplicationRequestItemProvider extends ExperimentScenarioRequestItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TerminateApplicationRequestItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RequestPackage.Literals.TERMINATE_APPLICATION_REQUEST__RUNNING_APPLICATION_SELECTOR);
		}
	...
	/**
	 * This returns TerminateApplicationRequest.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TerminateApplicationRequest"));
	}
	...
	public String getText(Object object) {
		String label = ((TerminateApplicationRequest)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TerminateApplicationRequest_type") :
			getString("_UI_TerminateApplicationRequest_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TerminateApplicationRequest.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(RequestPackage.Literals.TERMINATE_APPLICATION_REQUEST__RUNNING_APPLICATION_SELECTOR,
