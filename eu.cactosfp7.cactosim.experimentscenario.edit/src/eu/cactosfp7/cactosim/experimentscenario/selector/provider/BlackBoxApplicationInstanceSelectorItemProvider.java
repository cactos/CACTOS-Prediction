...
/**
 * This is the item provider adapter for a {@link eu.cactosfp7.cactosim.experimentscenario.selector.BlackBoxApplicationInstanceSelector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BlackBoxApplicationInstanceSelectorItemProvider extends NonWhiteBoxApplicationInstanceSelectorItemProvider {
	...
	public String getText(Object object) {
		String label = ((BlackBoxApplicationInstanceSelector)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_BlackBoxApplicationInstanceSelector_type") :
			getString("_UI_BlackBoxApplicationInstanceSelector_type") + " " + label;
	}
