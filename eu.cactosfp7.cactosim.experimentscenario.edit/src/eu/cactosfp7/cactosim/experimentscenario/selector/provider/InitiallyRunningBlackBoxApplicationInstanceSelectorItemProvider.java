...
/**
 * This is the item provider adapter for a {@link eu.cactosfp7.cactosim.experimentscenario.selector.InitiallyRunningBlackBoxApplicationInstanceSelector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InitiallyRunningBlackBoxApplicationInstanceSelectorItemProvider extends BlackBoxApplicationInstanceSelectorItemProvider {
	 ...
	 * @generated
	 */
	public InitiallyRunningBlackBoxApplicationInstanceSelectorItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InitiallyRunningBlackBoxApplicationInstanceSelector"));
	}
	...
	public String getText(Object object) {
		String label = ((InitiallyRunningBlackBoxApplicationInstanceSelector)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_InitiallyRunningBlackBoxApplicationInstanceSelector_type") :
			getString("_UI_InitiallyRunningBlackBoxApplicationInstanceSelector_type") + " " + label;
	}
