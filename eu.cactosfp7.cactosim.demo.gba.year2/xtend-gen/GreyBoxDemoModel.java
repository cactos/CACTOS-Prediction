    ...
    for (final int i : _doubleDotLessThan) {
      {
        ...
        final Procedure1<ComputeNode> _function_5 = (ComputeNode it_1) -> {
          ...
          final Procedure1<ProcessingUnitSpecification> _function_6 = (ProcessingUnitSpecification it_2) -> {
            it_2.setName("Intel(R) Core(TM) i5-3470");
          ...
          if ((i < this.numberNodesHdd)) {
            ...
            StorageSpecification _createStorageSpecification_1 = this.pcoref.createStorageSpecification();
            final Procedure1<StorageSpecification> _function_8 = (StorageSpecification it_2) -> {
              it_2.setName("Local SSD");
              Unit<DataAmount> _GIGA = SI.<DataAmount>GIGA(NonSI.BYTE);
              Amount<DataAmount> _valueOf = Amount.<DataAmount>valueOf(220, _GIGA);
              it_2.setSize(_valueOf);
              Amount<Duration> _valueOf_1 = Amount.<Duration>valueOf(0, SI.SECOND);
              ...
              it_2.setReadBandwidth(_doubleArrow_7);
              Amount<Duration> _valueOf_2 = Amount.<Duration>valueOf(0, SI.SECOND);
              it_2.setWriteDelay(_valueOf_2);
              Bandwidth _createBandwidth_1 = this.puf.createBandwidth();
              ...
              it_2.setWriteBandwidth(_doubleArrow_8);
            };
            StorageSpecification _doubleArrow_7 = ObjectExtensions.<StorageSpecification>operator_doubleArrow(_createStorageSpecification_1, _function_8);
            _storageSpecifications_1.add((this.storage1 = _doubleArrow_7));
          }
          ...
          final Procedure1<MemorySpecification> _function_9 = (MemorySpecification it_2) -> {
            ...
            Bandwidth _doubleArrow_8 = ObjectExtensions.<Bandwidth>operator_doubleArrow(_createBandwidth, _function_10);
            it_2.setBandwidthRead(_doubleArrow_8);
            Bandwidth _createBandwidth_1 = this.puf.createBandwidth();
            final Procedure1<Bandwidth> _function_11 = (Bandwidth it_3) -> {
              Unit<DataRate> _GIGA_1 = SI.<DataRate>GIGA(DataRate.UNIT);
              Amount<DataRate> _valueOf_1 = Amount.<DataRate>valueOf((25.132 * 8), _GIGA_1);
              it_3.setValue(_valueOf_1);
            };
            Bandwidth _doubleArrow_9 = ObjectExtensions.<Bandwidth>operator_doubleArrow(_createBandwidth_1, _function_11);
            it_2.setBandwidthWrite(_doubleArrow_9);
          };
          MemorySpecification _doubleArrow_8 = ObjectExtensions.<MemorySpecification>operator_doubleArrow(_createMemorySpecification, _function_9);
          _memorySpecifications.add((this.mem1 = _doubleArrow_8));
